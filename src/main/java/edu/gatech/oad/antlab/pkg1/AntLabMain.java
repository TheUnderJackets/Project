 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Lixin Wang");
		  toPrint += p1.toString("lwang401");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Hudson Lynam");
		  toPrint += p2.toString("hlynam3");
      ...
      Person4 p4 = new Person4("Andrew Suh");
      toPrint += p4.toString("asuh9");
      //Person5 replace P4 with your name
      //and gburdell5 with your gt id
      Person5 p5 = new Person5("Ben French");
      toPrint += p5.toString("bfrench6");
